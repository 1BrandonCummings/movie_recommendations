...
class RecommendationsControllerTest < ActionController::TestCase
  ...
  test "should create recommendation" do
    assert_difference('Recommendation.count') do
      post :create, recommendation: { genre: @recommendation.genre, title: @recommendation.title, user_id_id: @recommendation.user_id_id, votes: @recommendation.votes, watched: @recommendation.watched }
    end
  ...
  test "should update recommendation" do
    patch :update, id: @recommendation, recommendation: { genre: @recommendation.genre, title: @recommendation.title, user_id_id: @recommendation.user_id_id, votes: @recommendation.votes, watched: @recommendation.watched }
    assert_redirected_to recommendation_path(assigns(:recommendation))
  end
